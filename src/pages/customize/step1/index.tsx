...
import { useTracklistValidate, type YoutubeVideoInfo } from '@/features/customize'
import type { CustomizeStepProps } from '@/pages/customize'
import { StepHeader, TrackItem, ToggleSwitch } from '@/pages/customize/ui'
import { MUSIC_GENRES } from '@/shared/config/musicGenres'
import type { MusicGenre } from '@/shared/config/musicGenres'
import { flexColCenter, flexRowCenter } from '@/shared/styles/mixins'
import { Cd, Input, BottomSheet, Loading, Divider } from '@/shared/ui'
          ...
          <TrackInputBox>
            <InputItem $isError={!!trackErrMsg}>
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.nativeEvent.isComposing || e.key !== 'Enter' || !currentTrackUrl) return
                  onTrackAddClick()
                }}
              />
              <InputCleanButton
