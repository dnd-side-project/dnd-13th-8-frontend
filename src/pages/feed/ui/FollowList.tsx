...
import { FollowButton, useFollowList, type FollowSortType } from '@/features/follow'
...
const FollowList = ({ type }: FollowListProps) => {
  ...
  const { data, isLoading, isFetching, isError, fetchNextPage, hasNextPage } = useFollowList(
    type,
    shareCode || '',
    selected
  )
